...
input_nix="${tmp_dir}/fs270-sms010-policy-point-transit.nix"
output_json="${tmp_dir}/fs270-sms010-policy-point-transit.json"
...
echo "PASS FS-270-HDS-010-SDS-010-SMS-010"
