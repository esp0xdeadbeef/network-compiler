...
- evidence: `NETWORK_REPO_DIRECT_TEST_OK=1 NETWORK_LABS_PATH=/home/deadbeef/github/network-labs bash tests/FS-525-HDS-010-SDS-010-SMS-010-named-core-resolver-binding.sh` proves the positive multi-egress profile plus missing, literal, invalid, ambiguous, and static-upstream warnings. Candidate identities are sorted, input permutation is byte-equivalent apart from site identity, and warning records contain no address values.
