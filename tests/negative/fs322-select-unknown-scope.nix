...
{
  goodsite = baseSite // {
    topology = baseSite.topology // {
      nodes = baseSite.topology.nodes // {
        core = baseSite.topology.nodes.core // {
          offers = [
            "0.0.0.0/0"
            "::/0"
          ];
        };
        access = baseSite.topology.nodes.access // {
          offers = [
            "10.20.10.0/24"
            "fd42:dead:beef:10::/64"
          ];
          selects = [ "not-a-modeled-scope" ];
        };
      };
    };
